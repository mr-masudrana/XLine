...
class ContactsFragment : Fragment() {
    override fun onCreateView(
        ...
        view.findViewById<ImageView>(R.id.emptyStateIcon).setImageResource(R.drawable.ic_contacts)
        view.findViewById<TextView>(R.id.emptyStateTitle).text = "No contacts yet"
